...
<html lang="en">
  <head>
    ...
    <!-- vendor css -->
    <link href="lib-starlight/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="lib-starlight/Ionicons/css/ionicons.css" rel="stylesheet">


    <!-- Starlight CSS -->
    <link rel="stylesheet" href="css-starlight/starlight.css">
  </head>
...
or unavailable. Maybe you could try a search:</p>
        ...
        <div class="tx-center mg-t-20">... or back to <a href="index.php">home</a></div>
      </div>
    </div><!-- ht-100v -->

    <script src="lib-starlight/jquery/jquery.js"></script>
    <script src="lib-starlight/popper.js/popper.js/popper.js"></script>
    <script src="lib-starlight/bootstrap/bootstrap.js"></script>
